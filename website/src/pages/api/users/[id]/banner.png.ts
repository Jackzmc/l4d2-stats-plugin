...
export const GET: APIRoute = async ({ params, request, url }) => {
  ...
  startPos[1] += lineHeight
  drawText(ctx, `Farthest Shot of ${topStats?.longest_shot_distance.value ? Math.round(parseFloat(topStats.longest_shot_distance.value)*UNITS_TO_METERS) : 0} meters`, startPos[0], startPos[1], { font: statFont })  
  startPos[1] += lineHeight
